...
public class DataNode implements IDataNode {
	...
	public void deleteFile(String hashRange) {
		System.out.println("My Node Id: "+ this.myNodeId);
		String[] tempStr = hashRange.split(":");
		...
		if(tempStr[1].equals("-1")){
			System.out.println("Files corresponding to Hash range: "+ tempStr[0] +" deleted\n");
		}
		else {
			String payload = tempStr[0]+":-1";
			String nodeIp = this.routingTableObj.physicalTable.get(Integer.parseInt(tempStr[1]));
			System.out.println("Files corresponding to Hash range: "+ tempStr[0] +" deleted\n");
